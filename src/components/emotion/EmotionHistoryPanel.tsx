...
export default function EmotionHistoryPanel() {
  ...
  const [activeFilter, setActiveFilter] = useState<"all" | "face" | "speech">(
    "all"
  );
  const { token } = useAuth();
      ...
      setTimeout(() => {
        const mockData: EmotionRecord[] = [
          ...
          },
          {
            ...
            responseGiven:
              "I notice you seem sad. It's okay to feel this way. Would you like to talk about what's bothering you?",
          ...
          },
          {
            ...
            detectionMethod: "speech",
            responseGiven:
              "You seem concerned or anxious. Remember that you're safe here. Is there something specific that's worrying you?",
            createdAt: new Date(
  ...
  const filteredRecords =
    activeFilter === "all"
      ...
      : emotionRecords.filter(
          (record) => record.detectionMethod === activeFilter
        );
  ...
  const getEmotionColor = (emotion: string) => {
    ...
    return (
      emotionColors[emotion] || { text: "text-gray-800", bg: "bg-gray-100" }
    );
  };
        ...
        {isLoading ? (
          ...
          <div className="py-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Get started by performing an emotion detection.
            </p>
          </div>
        ) : (
                ...
                return (
                  <li key={record._id} className="py-5">
                    <div className="flex items-start">
                      <div
                        className={`flex-shrink-0 rounded-full p-2 ${emotionStyle.bg}`}
                      >
