...
export default function SymptomsPage() {
  ...
  const symptomCategories = [
    {
      ...
      symptoms: [
        ...
        },
        {
          ...
          description:
            "Challenges in developing and following a plan, working with numbers, or following a familiar recipe.",
        ...
        },
        {
          ...
          description:
            "Losing track of dates, seasons, and the passage of time. May forget where they are or how they got there.",
        ...
        },
        {
          ...
          description:
            "Trouble reading, judging distance, determining color or contrast, which may cause issues with driving.",
      ...
      symptoms: [
        {
          ...
          description:
            "Becoming easily upset, confused, suspicious, depressed, fearful, or anxious. May also become irritable when out of their comfort zone.",
        ...
        },
        {
          ...
          description:
            "Removing themselves from hobbies, social activities, work projects, or sports. May have trouble keeping up with favorite teams or activities.",
        ...
        },
        {
          ...
          description:
            "Changes in sleep patterns, including difficulty sleeping, daytime sleeping, or nighttime wandering.",
        ...
        },
        {
          ...
          description:
            "Becoming unusually frustrated, angry, or combative, especially in situations where cognitive limitations are challenged.",
    ...
    },
    {
      ...
      description:
        "Physical manifestations that may indicate Alzheimer's disease",
      symptoms: [
        {
          name: "Difficulty with Daily Tasks",
          description:
            "Trouble completing familiar tasks like driving to a known location, managing a budget, or remembering rules of a favorite game.",
        ...
        },
        {
          ...
          description:
            "Changes in coordination, balance, or movement patterns as the disease progresses.",
        ...
        },
        {
          name: "Weight Changes",
          description:
            "Unexplained weight loss or gain, which may be related to forgetting to eat or changes in food preferences.",
        ...
        },
        {
          name: "Incontinence",
          description:
            "Loss of bladder or bowel control in later stages of the disease.",
      ...
      symptoms: [
        {
          ...
          description:
            "Trouble following or joining a conversation. May struggle to find the right word or call things by the wrong name.",
        ...
        },
        {
          ...
          description:
            "Repeating the same statements, questions, or stories multiple times without realizing it.",
        ...
        },
        {
          ...
          description:
            "Using simpler language and fewer words, with diminishing ability to express complex thoughts.",
        ...
        },
        {
          ...
          description:
            "Difficulty with writing, including spelling, grammar, and organizing thoughts on paper.",
  ...
  const currentCategory =
    symptomCategories.find((category) => category.id === activeCategory) ||
    symptomCategories[0];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-500">
              Understanding the symptoms of Alzheimer&apos;s disease is crucial
              for early detection and intervention. Learn about the common signs
              to watch for.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p className="text-lg text-gray-700">
              Alzheimer&apos;s disease manifests through a range of symptoms
              that can vary from person to person. These symptoms typically
              develop slowly and worsen over time, eventually becoming severe
              enough to interfere with daily tasks. Recognizing these signs
              early can lead to better management and care planning.
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-2 text-amber-700">
                  If you notice any of these signs in yourself or someone you
                  know, don&apos;t ignore them. Schedule an appointment with
                  your doctor.
                </p>
          ...
          <div className="bg-blue-600 rounded-lg p-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-6 max-w-3xl mx-auto">
              Early detection improves outcomes. Use our AI-powered tools to
              assess risk factors.
            </p>
